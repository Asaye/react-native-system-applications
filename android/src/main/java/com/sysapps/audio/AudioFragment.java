...
public class AudioFragment extends Fragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		return inflater.inflate(com.sysapps.R.layout.sysapps_fragment_audio, container, false);
	}

	@Override
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mButtonAudio = (Button) view.findViewById(com.sysapps.R.id.audio);
        mTextAudio = (TextView) view.findViewById(com.sysapps.R.id.audioText);
        mButtonAudio.setOnClickListener(this);
        mButtonAudio.setText(com.sysapps.R.string.start);
        mTextAudio.setText(com.sysapps.R.string.ready);
    }	
	...
	void startRecordingAudio() {
		try {				
			...
			mButtonAudio.setText(com.sysapps.R.string.stop);
			mTextAudio.setText(com.sysapps.R.string.recording);
