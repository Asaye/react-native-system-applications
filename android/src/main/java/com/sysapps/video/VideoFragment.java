...
public class VideoFragment extends Fragment implements TextureView.SurfaceTextureListener, View.OnClickListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.sysapps.R.layout.sysapps_fragment_video, container, false);
    }

    @Override
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mTextureView = (AutoFitTextureView) view.findViewById(com.sysapps.R.id.texture);
        mButtonVideo = (Button) view.findViewById(com.sysapps.R.id.video);
        mButtonVideo.setOnClickListener(this);
        mButtonVideo.setText(com.sysapps.R.string.start);
    }
                    ...
                    if (activity != null) {
                    	activity.runOnUiThread(new Runnable() {
	                        ...
	                        public void run() {
			                    ...
			                    mButtonVideo.setText(com.sysapps.R.string.stop);
